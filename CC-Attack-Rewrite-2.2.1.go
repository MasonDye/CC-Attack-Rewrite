...
var version = "2.2.1 (BUILD 2023/11/17 12:00)"
	...
	for i := 0; i < *threadCount; i++ {
		...
		go func() {
			...
			for {
				...
				successCount++
				// Print attack info
				fmt.Printf("\033[31mRequested:%d \033[0m|\033[31m URL:%s \033[0m|\033[31m Thread:%d \033[0m|\033[31m Time:%d \033[0m|\033[31m Timeout:%d \033[0m\n", successCount, *targetURL, *threadCount, *requestInterval, *timeout)
